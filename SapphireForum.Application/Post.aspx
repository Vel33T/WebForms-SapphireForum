                    ...
                    <li id="main-comment">
                        ...
                        <div class="media">
                            <div class="pull-left text-center">
                                ...
                                <img class="media-object user-avatar" src="Content/Avatars/<%#: Item.User.AvatarLink %>" width="80" height="80" />
            ...
            <li id="new-comment">
                <div class="media">
                    <div class="pull-left text-center">
                        ...
                        <img id="NewCommentImage" runat="server" class="media-object user-avatar" src="Content/Avatars/" width="80" height="80" />
                    </div>
                    <div class="media-body">
                        <div class="media">
                            <div class="bubble-content">
