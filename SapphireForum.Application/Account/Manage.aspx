<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="SapphireForum.Application.Account.Manage" %>
    ...
    <div class="row-fluid">
        <div class="span6">
            ...
            <section id="ImageForm">
                <h3>Change Avatar</h3>
                <hr />
                <asp:Image ID="ImageAvatar" runat="server" CssClass="image-form-upload-img img-polaroid" Width="140" Height="140"/>
                <br />
                <asp:FileUpload ID="FileUploadAvatar" runat="server" />
                <br />
                <asp:Button ID="ButtonUpload" runat="server" Text="Upload" OnClick="ButtonUpload_Click" CssClass="btn"/>
            </section>
